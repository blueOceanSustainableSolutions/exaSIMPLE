...
!!     ReFRESCO
!!
!!     $Id: common_user_code.F90.xml 6732 2020-02-11 16:15:27Z JWindt@MARIN.LOCAL $
!!
...
DO icell=1,nAllCells
  ...
  exact_v_c_3(icell,1) = 4.0d0*y*(1.0d0-y)
  exact_grad_v_c_33(icell,1,1) = 0.0d0
  exact_grad_v_c_33(icell,1,2) = 4.0d0-8.0d0*y
  exact_grad_v_c_33(icell,1,3) = 0.0d0

  exact_v_c_3(icell,2) = 0.0d0
  exact_grad_v_c_33(icell,2,1) = 0.0d0
  exact_grad_v_c_33(icell,2,2) = 0.0d0
  ...
  exact_p_c(icell) = 8.0d0*mu*(2.0d0-x)+1.0d0
  exact_grad_p_c_3(icell,1) = -8.0d0*mu
  exact_grad_p_c_3(icell,2) = 0.0d0
