...
!!     ReFRESCO
!!
!!     $Id: set_phi.F90.xml 7221 2020-11-06 12:18:31Z MDeij@MARIN.LOCAL $
!!
...
INTEGER  :: ifamily, inletFamilyLoc
INTEGER  :: iface, icell
...
CALL fielddata_get_pointer("ExactPressure", Field=exact_p_c)
